...
| Координатор allowed-tools | Не указаны (полный доступ) | Координатор управляет агентами через Agent tool; поведенческие ограничения в теле команды запрещают прямую модификацию файлов |
...
| Координатор случайно читает исходники | Инструкции в теле команды явно запрещают ("You do NOT implement changes yourself") |
